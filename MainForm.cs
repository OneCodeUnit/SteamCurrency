    ...
    public partial class MainForm : Form
    {
        ...
        private void TextBoxInput_TextChanged(object sender, EventArgs e)
        {
            ...
            if (Reverse == false)
            {
                ...
                TextBoxInputKZT.Text = Math.Round(RUB_Input / RUB_USD_Qiwi, 4, MidpointRounding.ToNegativeInfinity).ToString(CultureInfo.InvariantCulture);
            }
        }
        ...
        private void TextBoxInputUsdWeb_TextChanged(object sender, EventArgs e)
        {
            ...
            CalcPercent();
            LabelUsdInputWeb.Text = Program.ChangeEnding(TextBoxInputUsdWeb.Text);
        }
    }
}